...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-union-e640
```

A live public deployment of this template is available at [https://tiny-union-e640.templates.workers.dev](https://tiny-union-e640.templates.workers.dev)
